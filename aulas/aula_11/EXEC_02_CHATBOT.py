...
BASE_CONHECIMENTO = {
    ...
    "diabetes": {
        "keywords": ["diabetes", "diabetes tipo 1", "diabetes tipo 2", "diabetes gestacional", "diabetes mellitus"],
        "resposta": (
            "DIABETES:\n"
            "  • Tipo 1: autoimune, insulina dependente\n"
            "  • Tipo 2: resistência à insulina, obesidade\n"
            "  • Gestacional: gestação com alta glicemia\n"
            "  • Tratamento: medicamentos, dieta, exercício"
        )
    },
}
