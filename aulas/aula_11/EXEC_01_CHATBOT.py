...
def responder(mensagem: str) -> str:
    ...
    # --- PERGUNTAS SOBRE O SISTEMA ---
        ...
        return (
            "Diabetes é uma doença crônica que afeta a forma como o corpo usa o açúcar (glicose) no sangue. "
            "O corpo não consegue usar o açúcar adequadamente, o que pode levar a vários problemas de saúde. "
            "O diabetes pode ser tratado com medicamentos e mudanças na dieta e no estilo de vida. "
            "O diabetes pode ser tratado com medicamentos e mudanças na dieta e no estilo de vida. "
        )

    elif msg == "o que é hipertensão":
        return (
            "Hipertensão é uma condição médica que afeta a pressão arterial. "
            "A pressão arterial é a força do sangue nas paredes das artérias. "
            "A pressão arterial alta pode levar a vários problemas de saúde, como infarto, derrame cerebral e doenças cardiovasculares. "
            "A hipertensão pode ser tratada com medicamentos e mudanças na dieta e no estilo de vida. "
        )

    elif msg == "o que é anemia":
        return (
            "Anemia é uma condição médica que afeta a quantidade de hemoglobina no sangue. "
            "A hemoglobina é uma proteína que transporta oxigênio para os tecidos do corpo. "
            "A anemia pode ser causada por falta de ferro, vitamina B12 ou ácido fólico. "
            "A anemia pode ser tratada com medicamentos e mudanças na dieta e no estilo de vida. "
        )
