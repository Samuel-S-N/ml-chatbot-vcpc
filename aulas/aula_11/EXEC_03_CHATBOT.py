...
def gerar_base_faq() -> pd.DataFrame:
    ...
    dados = [
        ...
        # ── SEDENTARISMO (5 perguntas) ─────────────────────────────────────
        { 
            "id": 41, "categoria": "sedentarismo", "intencao": "info_sedentarismo",
            "pergunta": "o que é sedentarismo",
            "resposta": "Sedentarismo é a falta de atividade física regular. Pode aumentar o risco de doenças crônicas como diabetes, pressão alta e obesidade."
        },
        {
            "id": 42, "categoria": "sedentarismo", "intencao": "info_sedentarismo",
            "pergunta": "como prevenir o sedentarismo",
            "resposta": "Pratique exercícios aeróbicos regularmente, como caminhada, corrida, natação ou bike. Inclua atividades de força (musculação) para melhorar a saúde cardiovascular."
        },
        {
            "id": 43, "categoria": "sedentarismo", "intencao": "info_sedentarismo",
            "pergunta": "sedentarismo aumenta o risco de doenças",
            "resposta": "Sim. Sedentarismo aumenta o risco de doenças crônicas como diabetes, pressão alta e obesidade. Pratique exercícios aeróbicos regularmente para reduzir o risco."
        },
        {
            "id": 44, "categoria": "sedentarismo", "intencao": "info_sedentarismo",
            "pergunta": "sedentarismo causa obesidade",
            "resposta": "Sim. Sedentarismo aumenta o risco de obesidade. Pratique exercícios aeróbicos regularmente para reduzir o risco."
        },
        {
            "id": 45, "categoria": "sedentarismo", "intencao": "info_sedentarismo",
            "pergunta": "sedentarismo causa diabetes",
            "resposta": "Sim. Sedentarismo aumenta o risco de diabetes. Pratique exercícios aeróbicos regularmente para reduzir o risco."
        },
